...
export default function ShiftingCheckerFallback() {
  return (
    <div
      style={{
        minHeight: "100vh",
    ...
    >
      <h1 style={{ fontSize: "2.5rem", marginBottom: "1rem" }}>
        🗺️ Geo-Mapper Pro — Shifting Checker
      </h1>
      <p
        style={{
      ...
      >
        ...
        <br />
        <br />
        Dalam konfigurasi <em>production</em>, rute{" "}
        <code>/apps/shifting-checker</code> akan di-<em>redirect</em> oleh{" "}
        <strong>Nginx</strong> langsung ke halaman Streamlit{" "}
        <strong>3_Shifting_Checker</strong>. <br />
        <br />
      ...
      >
        ...
        <ul style={{ color: "var(--text-secondary)", marginLeft: "1.5rem" }}>
          ...
          <li>
            Buka browser ke:{" "}
            <a
              href="http://localhost/apps/shifting-checker"
              style={{ color: "var(--accent-cyan)", fontWeight: "bold" }}
            >
              http://localhost/apps/shifting-checker
            </a>
          </li>
        </ul>
      </div>
